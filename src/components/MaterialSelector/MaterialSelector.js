            ...
            return (
              ...
              >
                {currentActiveLayers.includes(material.name) ? (
                  ...
                  <div className='hidden transition-all duration-800 xl:block relative px-2 w-[80px] lg:w-[80px] left-[3px] text-[10px] w-full flex justify-center items-center flex h-full rounded-l border-white' />
                )}
