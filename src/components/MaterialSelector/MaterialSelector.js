            ...
            return (
              ...
              >
                {currentActiveLayers.includes(material.name) ? (
                  <div className='relative transition-all duration-100 w-[100px] left-[3px] lg:w-[80px] text-[9px] w-full flex justify-center items-center flex h-full bg-white rounded-l border-white'>
                    {material.name}
                  </div>
                ) : (
                  <div className='hidden transition-all duration-100 xl:block relative px-2 w-[80px] lg:w-[80px] left-[3px] text-[9px] w-full flex justify-center items-center flex h-full rounded-l border-white' />
                )}
